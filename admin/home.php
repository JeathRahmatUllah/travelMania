							...
							if (mysqli_num_rows($result) > 0) {
								while ($row =  mysqli_fetch_assoc($result)) {
									...
									if($row['image']==NULL){
										...
										echo '   
										 <form action="upload.php?username=' . $username . '&id='.$row['id'].'" method="post" enctype="multipart/form-data" class="form-control">' ?>
									 ...
									 <?php 
										...
										echo  '<img src="uploads/'.$row['image'].'" alt="" height="100px" width="100px">';
									}
									  echo "</td>";
