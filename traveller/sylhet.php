...
?>
                                        ...
                                        if (mysqli_num_rows($res) > 0) {
                                            while ($row = mysqli_fetch_assoc($res)) {
                                                ...
                                                if($row['stat']=='Not Conform'){
                                                    echo '<a href="payment.php"><button class="px-5 py-2 border border-red-500 hover:bg-red-500 hover:text-white">Payment</button></a>';
                                                }
                                                else{
                                                    echo $row['price'];
                                                }
            ...
            <div>
                ...
                $sql1 = "select * from hotel where hotel_area = 'sylhet'";
                $res = mysqli_query($conn, $sql1);
                if (mysqli_num_rows($res) > 0) {
                    while ($row = mysqli_fetch_assoc($res)) {
                        // echo "<span style='color:white; font-size: 40px'>Your search result: &nbsp;&nbsp;</span>";
